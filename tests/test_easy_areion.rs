...
//!
//! Symmetric counterpart to `bindings/python/tests/test_areion.py` —
...
//! [`Encryptor::import_state`] (JSON blob, single round-trip) instead
...
const AREION_HASHES: &[(&str, i32)] = &[("areion256", 256), ("areion512", 512)];
